...
| [SKILLS.md](SKILLS.md) | **Which agent skills apply here** — and the ~193 catalog skills that target infrastructure OGIP does not have (Jira, GitLab, ClickHouse, SSH fleet). Read before reaching for a skill. |
