...
| 3 | **HLTB** | main / extra / completionist hours | **scrape** — the P1 slice | scope/length → scope classification |
| 4 | **Metacritic / OpenCritic** | critic + user scores | scrape / API | quality dimension |
...
| 11 | **SteamCharts / player counts** | concurrent-players history | scrape | traction time series |
| 12 | **Kickstarter** | disclosed campaign budgets | scrape / datasets | indie budget calibration |
